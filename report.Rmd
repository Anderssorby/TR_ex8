...
We can see the model fit in figure \ref{fig:structfit} which seems to be not so good. The residuals seem to have some seasonality, which is confirmed to be significant by the Ljung-Box statistic.
