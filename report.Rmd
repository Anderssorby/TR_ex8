...
We can now define an exlpicit conditional density
\begin{equation}
...
###State space
We are using the Structural model given by the r function StructTS to fit our data. This was significantly easier than other approaches. 
